...
public class Agency {
    ...
    public void showClients (){ this.clientList.forEach(System.out::println);}
    public void showPackage (){ this.turistPackageList.forEach(System.out::println);}

    public void showPackageClient (){ this.packageClientList.forEach(System.out::println);}
